describe('Asym.decryptString()', () => {
  ...
  it('should call decrypt and return decoded', () => {
    ...
    const result = Encryption.asym.decryptString(message, nonce, keyPair.publicKey, keyPair.secretKey);
  ...
  describe('e2e', () => {
    ...
    beforeEach(() => {
      encrypted = Encryption.asym.encryptString(message, nonce, their.publicKey, my.secretKey);
      decrypted = Encryption.asym.decryptString(encrypted, nonce, my.publicKey, their.secretKey);
    });
